...
public class TVDatabase extends SQLiteOpenHelper
{
	...
	private void insertNewRegion(String name, int mode, String frequencies){
		ContentValues cv = new ContentValues();
		Log.d(TAG, "Loading region "+name+", source "+mode);
		cv.put("name", name);
		cv.put("source", mode);
		cv.put("frequencies", frequencies);
	 ...
	 * 生成内置频率表
	 */
	public void builtinRegions(){
		insertNewRegion("Default DVB-C", TVChannelParams.MODE_QAM, 
		...
		insertNewRegion("ATSC Air U.S.", TVChannelParams.MODE_ATSC,
					"0 57000000 63000000 69000000 79000000 85000000 177000000 183000000 189000000 195000000 201000000 207000000 213000000 "+
		...
		insertNewRegion("ATSC Cable Standard U.S.", TVChannelParams.MODE_ATSC,
					"0 57000000 63000000 69000000 79000000 85000000 177000000 183000000 189000000 195000000 201000000 207000000 213000000 "     +
					...
					"855000000 861000000");
		insertNewRegion("ATSC Cable IRC U.S.", TVChannelParams.MODE_ATSC,
		...
		insertNewRegion("ATSC Cable HRC U.S.", TVChannelParams.MODE_ATSC,
		...
		insertNewRegion("Default DVB-T UK", TVChannelParams.MODE_OFDM,
					...
					"858000000 0 ");
		insertNewRegion("Default DVB-T AUSTRALIA", TVChannelParams.MODE_OFDM,
		...
		insertNewRegion("Default DVB-T ITALY", TVChannelParams.MODE_OFDM,
					...
					"794000000 0 802000000 0 810000000 0 818000000 0 826000000 0 834000000 0 842000000 0 850000000 0 " +					
					"858000000 0 "); 
		insertNewRegion("Default DVB-T FRANCE", TVChannelParams.MODE_OFDM,
					"177500000 1 184500000 1 191500000 1 198500000 1 205500000 1 212500000 1 219500000 1 226500000 1 " +
					"474000000 0 482000000 0 490000000 0 498000000 0 506000000 0 514000000 0 522000000 0 530000000 0 " +
					"538000000 0 546000000 0 554000000 0 562000000 0 570000000 0 578000000 0 586000000 0 594000000 0 " +
					"602000000 0 610000000 0 618000000 0 626000000 0 634000000 0 642000000 0 650000000 0 658000000 0 " +
					...
					"794000000 0 802000000 0 810000000 0 818000000 0 826000000 0 834000000 0 842000000 0 850000000 0 " +
					"858000000 0 ");  					
		insertNewRegion("Default DVB-T TAIWAN", TVChannelParams.MODE_OFDM,
	...
	public void loadBuiltins(){
		/* builtin regions */
		Log.d(TAG, "Generating builtin regions...");
		builtinRegions();
